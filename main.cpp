    ...
    public:
        ...
        string getStats() const 
        {
            ...
            ss  << "============\n"
                ...
                << "Thirst: " << this->thirst << "\n"
                << "============\n";
            return ss.str(); // Return the string generated by the stringstream
        }
        ...
        // x axis and y axis
        uint8_t x, y;
        uint8_t health, hunger, thirst, score;
...
class HauntedHouse: public Land {
    ...
    string getDescription() {
        ...
        if (randomH < 25) 
        { // if the random variable is less than 25 then the player will have a math problem
    ...
    string visit(Player & p) {
            ...
            while (count1 < 1) {
                ...
                if (randomH < 13) {
                    if (input == 610 || input == 611) { // this is the right answer for the first challenge 
                        ...
                        return ("That's incorrect\n your health was decreased by 1");
        ...
        return ("You visited the haunted house"); //This just to clear compiler warnings.
